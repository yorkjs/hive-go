...
func TestFormatDateTime(t *testing.T) {
    ...
    tCurrentYear := time.Date(2026, 10, 1, 10, 1, 2, 0, time.Local).UnixMilli()
    ...
    tOtherYear := time.Date(2020, 10, 1, 10, 1, 2, 0, time.Local).UnixMilli()
    ...
    tStart := time.Date(2020, 10, 1, 10, 1, 2, 0, time.Local).UnixMilli()
    tEnd := time.Date(2020, 10, 1, 10, 3, 2, 0, time.Local).UnixMilli()
